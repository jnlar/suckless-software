...
static const char *fonts[]          = { "mono:size=11", "DejaVuSansMono Nerd Font Mono:size=15" };
...
static const char col_orange[] 		= "#772200";
static const char col_border[]		= "#110f0f";
static const char col_norm[]		= "#000000";
static const char col_white[]		= "#fef9e7";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray2, col_gray2 },
	[SchemeSel]  = { col_gray4, col_gray2,  "#1d2021"  },
...
/*	{ 0, XF86XK_WLAN,				spawn,					   SHCMD("network down") }, */
